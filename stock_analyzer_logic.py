...
# --- New Helper for Current Price Accuracy ---
def get_live_tick(ticker):
    """Fetches the absolute latest price using 1-minute data."""
    try:
...
def analyze_ticker(ticker):
    ...
    for tf_name in check_timeframes:
        ...
        # FIX: Safety check for old trends (SPY, GBPCAD etc) to prevent crash
        ...
        # FIX: Pull Live Tick instead of Daily Close for Current Price
        live_p = get_live_tick(ticker)
